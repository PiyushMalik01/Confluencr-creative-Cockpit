...
const pdfPath = path.resolve(__dirname, '..', 'TEST-RUN.pdf');
...
">
  <span>Test Run Output &middot; Bewakoof Friends Pivot oversized tee</span>
...
">
  <span style="text-transform: uppercase;">Confluencr Creative Cockpit &middot; Test Run v1</span>
